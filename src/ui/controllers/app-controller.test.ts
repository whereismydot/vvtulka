...
function createElements(): AppElements {
  ...
  return {
    ...
    shelfLifeDateError: document.createElement('p'),
    shelfLifeYesterdayButton: document.createElement('button'),
    shelfLifeCalendarButton: document.createElement('button'),
    shelfLifeDatePicker: document.createElement('input'),
